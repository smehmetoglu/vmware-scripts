...
# VCF Instance to deploy VCFMS
$VCFInstanceName = "William VCF 9 Instance 2"

# VCF Management Services (VCFMS) Configuration for non-Primary VCF Instance
...
try {
    My-Logger "Starting VCF Management Services (VCFMS) Deployment Validation on Non-Primary VCF Instance ..."
...
if($ValidateOnly -eq $false) {
    My-Logger "Starting VCF Management Services (VCFMS) Deployment to alternative network ${VCFManagementServicesNetworkName} on Non-Primary VCF Instance ..."
